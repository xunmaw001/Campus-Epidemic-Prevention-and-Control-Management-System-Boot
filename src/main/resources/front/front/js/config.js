...
var centerMenu = [
    ...
    ,{
        name: '隔离信息',
        url: '../fengkong/list.html'
    }
    ,{
        name: '上报信息',
        url: '../wangfanYuyue/list.html'
    }
    ,{
        name: '物资收藏',
        url: '../wuziCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '物资',
        url: './pages/wuzi/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/xiaoyuanyiqingfangkongguanlixitong/admin/dist/index.html#/login";
