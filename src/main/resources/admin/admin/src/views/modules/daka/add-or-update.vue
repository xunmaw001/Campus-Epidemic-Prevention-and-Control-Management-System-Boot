    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="健康码打卡" prop="dakaName">
                       <el-input v-model="ruleForm.dakaName"
                                 placeholder="健康码打卡" clearable  :readonly="ro.dakaName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="健康码打卡" prop="dakaName">
                           <el-input v-model="ruleForm.dakaName"
                                     placeholder="健康码打卡" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.dakaFile" label="健康码照片" prop="dakaFile">
                        <file-upload
                                tip="点击上传健康码照片"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.dakaFile?$base.url+ruleForm.dakaFile:''"
                                @change="dakaFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.dakaFile" label="健康码照片" prop="dakaFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.dakaFile"  >健康码照片下载</a>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="体温" prop="dakaWendu">
                       <el-input v-model="ruleForm.dakaWendu"
                                 placeholder="体温" clearable  :readonly="ro.dakaWendu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="体温" prop="dakaWendu">
                           <el-input v-model="ruleForm.dakaWendu"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="dakaText">
                        <el-input type="textarea"  :readonly="ro.dakaText" v-model="ruleForm.dakaText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.dakaText" label="备注" prop="dakaText">
                            <span v-html="ruleForm.dakaText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   dakaName: [
                              { required: true, message: '健康码打卡不能为空', trigger: 'blur' },
                          ],
                   dakaFile: [
                              { required: true, message: '健康码照片不能为空', trigger: 'blur' },
                          ],
                   dakaWendu: [
        ...
        methods: {
            ...
            //图片
            dakaFileUploadChange(fileUrls){
                this.ruleForm.dakaFile = fileUrls;
                this.addEditUploadStyleChange()
            },
